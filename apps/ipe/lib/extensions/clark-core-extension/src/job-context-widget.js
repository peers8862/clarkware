...
let JobContextWidget = class JobContextWidget extends widgets_1.ReactWidget {
    static { JobContextWidget_1 = this; }
    static ID = exports.JOB_CONTEXT_WIDGET_ID;
    static LABEL = 'Job Context';
    jobContext = null;
    constructor() {
        super();
...
//# sourceMappingURL=job-context-widget.js.map