...
let NotesWidget = class NotesWidget extends widgets_1.ReactWidget {
    static { NotesWidget_1 = this; }
    static ID = exports.NOTES_WIDGET_ID;
    static LABEL = 'Notes';
    notes = [];
    jobId = null;
    inputValue = '';
...
//# sourceMappingURL=notes-widget.js.map