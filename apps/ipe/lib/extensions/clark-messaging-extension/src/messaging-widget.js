...
let MessagingWidget = class MessagingWidget extends widgets_1.ReactWidget {
    static { MessagingWidget_1 = this; }
    static ID = exports.MESSAGING_WIDGET_ID;
    static LABEL = 'Messages';
    messages = [];
    connected = false;
    ws = null;
    streamId = null;
...
//# sourceMappingURL=messaging-widget.js.map